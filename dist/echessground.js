var Echessground = (function () {
	...
	function premove(pieces, key, canCastle) {
	    ...
	    if (!piece)
	        return [];
	    const pos = util.key2pos(key), r = piece.role, mobility = r === 'pawn' ? pawn(piece.color) : (r === 'knight' ? exports.knight : (r === 'bishop' ? bishop : (r === 'rook' ? rook : (r === 'elephant' ? exports.elephant : (r === 'queen' ? exports.queen :
	...
	const roles = { p: 'pawn', r: 'rook', n: 'knight', b: 'bishop', q: 'queen', k: 'king', e: 'elephant' };
	const letters = { pawn: 'p', rook: 'r', knight: 'n', bishop: 'b', queen: 'q', king: 'k', elephant: 'e' };
	function read(fen) {
	    if (fen === 'start')
	        fen = exports.initial;
	...
	var echessground = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	function Echessground(element, config$1) {
	...
	var src = echessground.Echessground;
